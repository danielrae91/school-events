...
import { StoredEvent, type Event } from '@/lib/types'
            ...
            <nav className="-mb-px flex space-x-8">
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-colors ${
                  activeTab === 'events' ? 'bg-purple-600 text-white' : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-colors ${
                  activeTab === 'suggestions' ? 'bg-purple-600 text-white' : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-colors ${
                  activeTab === 'feedback' ? 'bg-purple-600 text-white' : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                }`}
              >
              ...
              <Link
                href="/stats"
                className="px-4 py-2 rounded-lg transition-colors bg-slate-700 text-gray-300 hover:bg-slate-600"
              >
                📊 Stats
              </Link>
            </nav>
